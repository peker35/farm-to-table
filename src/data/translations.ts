...
export const auth = {
  ...
  invalidCredentials: { en: 'Invalid email or password', it: 'Email o password non validi', tr: 'Geçersiz e-posta veya şifre' },
  emailPlaceholder: { en: 'you@example.com', it: 'tu@esempio.com', tr: 'ornek@email.com' },
  confirmPassword: { en: 'Confirm Password', it: 'Conferma Password', tr: 'Şifreyi Onayla' },
  emailInUse: { en: 'Email already in use', it: 'Email già in uso', tr: 'Bu e-posta zaten kullanılıyor' },
}
...
export const checkout = {
  ...
  placeOrder: { en: 'Place Order', it: 'Effettua Ordine', tr: 'Sipariş Ver' },
...
export const events = {
  title: { en: 'Events & Workshops', it: 'Eventi e Workshop', tr: 'Etkinlikler ve Atölyeler' },
  subtitle: { en: 'Discover what is happening at our farm', it: 'Scopri cosa succede nella nostra fattoria', tr: 'Çiftliğimizde neler oluyor keşfedin' },
  allEvents: { en: 'All Events', it: 'Tutti gli Eventi', tr: 'Tüm Etkinlikler' },
  noEvents: { en: 'No events on this date.', it: 'Nessun evento in questa data.', tr: 'Bu tarihte etkinlik bulunmamaktadır.' },
  free: { en: 'Free', it: 'Gratuito', tr: 'Ücretsiz' },
  register: { en: 'Register', it: 'Registrati', tr: 'Kayıt Ol' },
}

export const account = {
  myAccount: { en: 'My Account', it: 'Il Mio Account', tr: 'Hesabım' },
  pleaseLogIn: { en: 'Please log in', it: 'Accedi', tr: 'Lütfen giriş yapın' },
  signIn: { en: 'Sign In', it: 'Accedi', tr: 'Giriş Yap' },
  profileUpdated: { en: 'Profile updated!', it: 'Profilo aggiornato!', tr: 'Profil güncellendi!' },
  passwordsNoMatch: { en: 'Passwords do not match!', it: 'Le password non corrispondono!', tr: 'Şifreler eşleşmiyor!' },
  passwordChanged: { en: 'Password changed!', it: 'Password cambiata!', tr: 'Şifre değiştirildi!' },
  profile: { en: 'Profile', it: 'Profilo', tr: 'Profil' },
  orders: { en: 'Orders', it: 'Ordini', tr: 'Siparişler' },
  password: { en: 'Password', it: 'Password', tr: 'Şifre' },
  addresses: { en: 'Addresses', it: 'Indirizzi', tr: 'Adresler' },
  logout: { en: 'Logout', it: 'Esci', tr: 'Çıkış' },
  profileInfo: { en: 'Profile Information', it: 'Informazioni Profilo', tr: 'Profil Bilgileri' },
  fullName: { en: 'Full Name', it: 'Nome Completo', tr: 'Ad Soyad' },
  phone: { en: 'Phone', it: 'Telefono', tr: 'Telefon' },
  email: { en: 'Email', it: 'Email', tr: 'E-posta' },
  address: { en: 'Address', it: 'Indirizzo', tr: 'Adres' },
  city: { en: 'City', it: 'Città', tr: 'Şehir' },
  zipCode: { en: 'ZIP Code', it: 'CAP', tr: 'Posta Kodu' },
  save: { en: 'Save', it: 'Salva', tr: 'Kaydet' },
  myOrders: { en: 'My Orders', it: 'I Miei Ordini', tr: 'Siparişlerim' },
  noOrders: { en: 'No orders yet', it: 'Ancora nessun ordine', tr: 'Henüz sipariş yok' },
  qty: { en: 'Qty', it: 'Qtà', tr: 'Adet' },
  changePassword: { en: 'Change Password', it: 'Cambia Password', tr: 'Şifre Değiştir' },
  currentPassword: { en: 'Current Password', it: 'Password Attuale', tr: 'Mevcut Şifre' },
  newPassword: { en: 'New Password', it: 'Nuova Password', tr: 'Yeni Şifre' },
  confirmPassword: { en: 'Confirm Password', it: 'Conferma Password', tr: 'Şifreyi Onayla' },
  change: { en: 'Change', it: 'Cambia', tr: 'Değiştir' },
  myAddresses: { en: 'My Addresses', it: 'I Miei Indirizzi', tr: 'Adreslerim' },
  noAddresses: { en: 'No addresses added yet', it: 'Ancora nessun indirizzo', tr: 'Henüz adres eklenmemiş' },
  addNewAddress: { en: 'Add New Address', it: 'Aggiungi Indirizzo', tr: 'Yeni Adres Ekle' },
  startShopping: { en: 'Start Shopping', it: 'Inizia lo Shopping', tr: 'Alışverişe Başla' },
}

export const admin = {
  dashboard: { en: 'Dashboard', it: 'Dashboard', tr: 'Kontrol Paneli' },
  products: { en: 'Products', it: 'Prodotti', tr: 'Ürünler' },
  producers: { en: 'Producers', it: 'Produttori', tr: 'Üreticiler' },
  orders: { en: 'Orders', it: 'Ordini', tr: 'Siparişler' },
  customers: { en: 'Customers', it: 'Clienti', tr: 'Müşteriler' },
  events: { en: 'Events', it: 'Eventi', tr: 'Etkinlikler' },
  settings: { en: 'Settings', it: 'Impostazioni', tr: 'Ayarlar' },
  viewAll: { en: 'View All', it: 'Vedi Tutto', tr: 'Tümünü Gör' },
  view: { en: 'View', it: 'Vedi', tr: 'Gör' },
  edit: { en: 'Edit', it: 'Modifica', tr: 'Düzenle' },
  delete: { en: 'Delete', it: 'Elimina', tr: 'Sil' },
  addNew: { en: 'Add New', it: 'Aggiungi', tr: 'Yeni Ekle' },
  save: { en: 'Save', it: 'Salva', tr: 'Kaydet' },
  ...
  search: { en: 'Search', it: 'Cerca', tr: 'Ara' },
  manageProducts: { en: 'Manage your product inventory', it: 'Gestisci il tuo inventario', tr: 'Ürün envanterini yönet' },
  manageProducers: { en: 'Manage your producers and farms', it: 'Gestisci produttori e fattorie', tr: 'Üreticileri ve çiftlikleri yönet' },
  manageOrders: { en: 'Manage customer orders', it: 'Gestisci ordini clienti', tr: 'Müşteri siparişlerini yönet' },
  manageCustomers: { en: 'View your customer base', it: 'Visualizza i tuoi clienti', tr: 'Müşteri listenizi görüntüleyin' },
  manageEvents: { en: 'Manage events', it: 'Gestisci gli eventi', tr: 'Etkinlikleri yönet' },
  confirmDelete: { en: 'Are you sure?', it: 'Sei sicuro?', tr: 'Emin misiniz?' },
  categories: { en: 'Categories', it: 'Categorie', tr: 'Kategoriler' },
  addCategory: { en: 'Add Category', it: 'Aggiungi Categoria', tr: 'Kategori Ekle' },
  addProduct: { en: 'Add Product', it: 'Aggiungi Prodotto', tr: 'Ürün Ekle' },
  editProduct: { en: 'Edit Product', it: 'Modifica Prodotto', tr: 'Ürün Düzenle' },
  editCategory: { en: 'Edit Category', it: 'Modifica Categoria', tr: 'Kategori Düzenle' },
  allCategories: { en: 'All Categories', it: 'Tutte le Categorie', tr: 'Tüm Kategoriler' },
  searchProducts: { en: 'Search products...', it: 'Cerca prodotti...', tr: 'Ürün ara...' },
  noProducts: { en: 'No products found', it: 'Nessun prodotto trovato', tr: 'Ürün bulunamadı' },
  ...
  inStock: { en: 'In Stock', it: 'Disponibile', tr: 'Stokta' },
  outOfStock: { en: 'Out of Stock', it: 'Non Disponibile', tr: 'Stokta Yok' },
  location: { en: 'Location', it: 'Posizione', tr: 'Konum' },
  description: { en: 'Description', it: 'Descrizione', tr: 'Açıklama' },
  price: { en: 'Price', it: 'Prezzo', tr: 'Fiyat' },
}
...
export const footer = {
  ...
  support: { en: 'Support', it: 'Supporto', tr: 'Yardım' },
