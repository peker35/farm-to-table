...
export const farms = [
  { id: 1, name: 'Hilltop Farm', nameEn: 'Hilltop Farm', nameIt: 'Fattoria Hilltop', nameTr: 'Hilltop Çiftliği', location: 'Hudson Valley, NY', locationEn: 'Hudson Valley, NY', locationIt: 'Valle Hudson, NY', locationTr: 'Hudson Valley, NY', description: 'Family-owned organic farm since 1985', descriptionEn: 'Family-owned organic farm since 1985', descriptionIt: 'Fattoria biologica familiare dal 1985', descriptionTr: '1985\'ten beri aile organik çiftliği', image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=400' },
  { id: 2, name: 'Green Valley', nameEn: 'Green Valley', nameIt: 'Valle Verde', nameTr: 'Yeşil Vadi', location: 'Upstate NY', locationEn: 'Upstate NY', locationIt: 'Upstate NY', locationTr: 'Upstate NY', description: 'Specializing in leafy greens and herbs', descriptionEn: 'Specializing in leafy greens and herbs', descriptionIt: 'Specializzati in verdure e erbe', descriptionTr: 'Yeşillik ve ot uzmanı', image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400' },
  { id: 3, name: 'Sunny Acres', nameEn: 'Sunny Acres', nameIt: 'Sunny Acres', nameTr: 'Güneşli Çiftlik', location: 'Long Island, NY', locationEn: 'Long Island, NY', locationIt: 'Long Island, NY', locationTr: 'Long Island, NY', description: 'Free-range eggs and poultry', descriptionEn: 'Free-range eggs and poultry', descriptionIt: 'Uova e pollame free-range', descriptionTr: 'Serbest gezen tavuk ve yumurta', image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=400' },
  { id: 4, name: 'She Wolf Bakery', nameEn: 'She Wolf Bakery', nameIt: 'She Wolf Bakery', nameTr: 'She Wolf Fırını', location: 'Brooklyn, NY', locationEn: 'Brooklyn, NY', locationIt: 'Brooklyn, NY', locationTr: 'Brooklyn, NY', description: 'Artisan sourdough and pastries', descriptionEn: 'Artisan sourdough and pastries', descriptionIt: 'Pani e lievitazione naturale artigianale', descriptionTr: 'Zanaatkâr ekmek ve hamur işleri', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400' },
]
